...
async function handleSubscribe(
  ...
  const html = [
    '<!DOCTYPE html><html lang="fr"><body style="margin:0;padding:0;background:#FFF9F2;font-family:Georgia,\'Times New Roman\',serif;">',
    '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#FFF9F2;padding:24px 12px;"><tr><td align="center">',
    '<table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">',
    '<tr><td style="background:#FFF6EA;border:3px solid #241405;border-radius:20px;">',
    '<table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr>',
    '<td style="background:#FF6B1A;border-bottom:3px solid #241405;border-radius:17px 17px 0 0;padding:28px 32px;background-image:radial-gradient(circle,#241405 1.5px,transparent 1.5px);background-size:22px 22px;">',
    '<p style="margin:0;font-family:Arial Black,Arial,sans-serif;font-size:26px;font-weight:900;color:#241405;letter-spacing:-0.5px;">FRANCEPASSOIRE</p>',
    '<p style="margin:6px 0 0;font-family:Courier New,monospace;font-size:13px;color:#241405;">La France, passoire à données. On compte les trous.</p>',
    '</td></tr></table>',
    '<table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr>',
    '<td style="padding:32px 32px 8px;font-family:Georgia,serif;color:#241405;font-size:16px;line-height:1.6;">',
    '<p style="margin:0 0 16px;">Bonjour,</p>',
    '<p style="margin:0 0 16px;">Vous avez demandé la <strong>veille FrancePassoire</strong> : les fuites de données touchant la France, dès qu\'elles sont vérifiées, selon vos critères.</p>',
    '<p style="margin:0 0 24px;">Un dernier clic et c\'est actif :</p>',
    '</td></tr></table>',
    '<table role="presentation" cellpadding="0" cellspacing="0" align="center" style="margin:0 auto 28px;"><tr>',
    '<td align="center" style="border:3px solid #241405;border-radius:14px;">',
    `<a href="${confirmUrl}" style="display:inline-block;padding:16px 36px;background:#FF6B1A;color:#241405;font-family:Arial Black,Arial,sans-serif;font-weight:900;font-size:17px;text-decoration:none;border-radius:11px;">Activer ma veille</a>`,
    '</td></tr></table>',
    '<table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr>',
    '<td style="padding:0 32px 28px;font-family:Georgia,serif;color:#241405;font-size:14px;line-height:1.6;">',
    '<p style="margin:0 0 8px;font-family:Courier New,monospace;font-size:12px;color:#241405;opacity:0.7;">Le bouton ne marche pas ? Copiez-collez ce lien (valable 24 heures) :</p>',
    `<p style="margin:0 0 20px;font-family:Courier New,monospace;font-size:12px;word-break:break-all;"><a href="${confirmUrl}" style="color:#E85A0C;">${confirmUrl}</a></p>`,
    '<p style="margin:0 0 8px;font-size:13px;">Si vous n\'êtes pas à l\'origine de cette demande, ignorez cet email : rien ne sera activé.</p>',
    '<div style="border-top:2px dashed #241405;padding-top:16px;margin-top:8px;">',
    '<p style="margin:0;font-family:Courier New,monospace;font-size:11px;color:#241405;opacity:0.75;">Votre email sert uniquement à vous envoyer ces alertes (consentement, double opt-in). Désinscription en un clic dans chaque email. Aucune donnée de victimes n\'est collectée, hébergée ou reproduite.</p>',
    '</div>',
    '</td></tr></table>',
    '</td></tr>',
    '</table>',
    '<p style="margin:16px 0 0;font-family:Courier New,monospace;font-size:11px;color:#241405;opacity:0.6;">© 2026 FrancePassoire — projet d\'utilité publique citoyenne</p>',
