# Cassettes sociales (T38–T40, T51)
...
l'envoi relais passe par un WebSocket factice injecté. X (bridge Make) et
TikTok (retiré en T51) n'ont plus de cassette : les webhooks Graph/Make sont
rejoués par des fetch injectés inline (tests/social-make-x, social-facebook,
social-instagram).
